...
export default function NewInvoiceScreen() {
  ...
  const preSelectedClient = urlClientId ? clients.find(c => c.id === urlClientId) : null;
  const preSelectedProject = urlProjectId ? projects.find(p => p.id === urlProjectId) : null;
  ...
  const handleCreateInvoice = async () => {
    const clientId = preSelectedClient ? preSelectedClient.id : selectedClient;
    const projectId = preSelectedProject ? preSelectedProject.id : selectedProject;
          ...
          {!urlClientId ? (
            ...
            <View style={styles.field}>
              ...
              <View style={styles.selectedClientContainer}>
                ...
                <Text style={styles.selectedClientText}>{preSelectedClient?.name}</Text>
              </View>
            </View>
          )}
          ...
          {!urlProjectId ? (
            ...
            <View style={styles.field}>
              ...
              <View style={styles.selectedClientContainer}>
                ...
                <Text style={styles.selectedClientText}>{preSelectedProject?.title}</Text>
              </View>
            </View>
          )}
        </Card>
