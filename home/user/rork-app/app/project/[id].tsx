  ...
  const handleTimelineItemPress = (item: string) => {
    ...
    switch (item) {
      ...
      case 'deposit-payment':
        router.push(`/payments?clientId=${project.clientId}&type=deposit&projectId=${project.id}`);
        break;
      case 'final-payment':
        router.push(`/payments?clientId=${project.clientId}&type=final&projectId=${project.id}`);
        break;
    ...
    <View style={styles.tabContent}>
      ...
      <View style={styles.quickInfoGrid}>
        ...
        >
          ...
          <Text style={styles.quickInfoLabel}>Client</Text>
          <Text style={styles.quickInfoValue}>{project.clientName}</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity 
          ...
          onPress={() => {
            ...
            router.push(`/payments?clientId=${project.clientId}`);
          }}
        >
          <View style={[styles.quickInfoIcon, { backgroundColor: colors.warning + '20' }]}>
            <CreditCard size={20} color={colors.warning} />
          </View>
          <Text style={styles.quickInfoLabel}>Payment</Text>
          <Text style={styles.quickInfoValue}>{project.paymentStatus}</Text>
        </TouchableOpacity>
      </View>
  ...
  const renderMessagesTab = () => {
    ...
    return (
      <View style={styles.messagesContainer}>
        ...
        <KeyboardAwareView style={styles.chatInputWrapper} enabled={true} isChatScreen={true}>
